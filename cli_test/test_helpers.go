...
func NewFixtures(t *testing.T) *Fixtures {
	tmpDir, err := ioutil.TempDir("", "gert_integration_"+t.Name()+"_")
...
// UnsafeResetAll is gertd unsafe-reset-all
...
// AddGenesisAccount is gertd add-genesis-account
...
// GDTendermint returns the results of gertd tendermint [query]
...
// ValidateGenesis runs gertd validate-genesis
