...
func TestKvCLIKeysAddRecover(t *testing.T) {
	...
	require.Equal(t, "gert1rsjxn2e4dfl3a2qzuzzjvvgjmmate383g9q4cz", f.KeyAddress("test-recover").String())
	...
	require.True(t, exitSuccess)
	require.Equal(t, "gert1qcfdf69js922qrdr4yaww3ax7gjml6pd39p8lj", f.KeyAddress("test-recover-legacy").String())

	// Cleanup testing directories
	f.Cleanup()
}

func TestgertCLIKeysAddRecoverHDPath(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	...
	require.Equal(t, "gert1rsjxn2e4dfl3a2qzuzzjvvgjmmate383g9q4cz", f.KeyAddress("test-recoverHD1").String())
	...
	require.Equal(t, "gert1qpj6nstqn0n5gzcsaezspuhulje6msjq5t8cq5", f.KeyAddress("test-recoverH2").String())
	...
	require.Equal(t, "gert1vayfpstgapt7dmv7074kc3ll8xpf0rlzvh4k08", f.KeyAddress("test-recoverH3").String())
	...
	require.Equal(t, "gert1xvsfnksmhr887skcfrm4pe3va54tkmrtw7wyer", f.KeyAddress("test-recoverH4").String())
	...
	require.Equal(t, "gert1v9plmhvyhgxk3th9ydacm7j4z357s3nhhmy0tv", f.KeyAddress("test-recoverH5").String())
	...
	require.True(t, exitSuccess)
	require.Equal(t, "gert1rsjxn2e4dfl3a2qzuzzjvvgjmmate383g9q4cz", f.KeyAddress("test-recoverH6").String())
	...
	require.True(t, exitSuccess)
	require.Equal(t, "gert1xvsfnksmhr887skcfrm4pe3va54tkmrtw7wyer", f.KeyAddress("test-recoverH7").String())
