...
func TestMigrateFull(t *testing.T) {
	...
	// File: https://s3.us-west-2.amazonaws.com/levi.testing.gert.io/gert-9-4-19-export-genesis.json
	// Height: 1145621
	genDoc, err := tmtypes.GenesisDocFromFile(filepath.Join("testdata", "gert-9-4-19-export-genesis.json"))
	assert.NoError(t, err)
