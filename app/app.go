...
import (
	...
	"github.com/Gert-Chain/core-bridge/x/bridge"
	bridgekeeper "github.com/Gert-Chain/core-bridge/x/bridge/keeper"
	bridgetypes "github.com/Gert-Chain/core-bridge/x/bridge/types"

	"github.com/Gert-Chain/core/app/ante"
	gertparams "github.com/Gert-Chain/core/app/params"
	"github.com/Gert-Chain/core/x/auction"
	auctionkeeper "github.com/Gert-Chain/core/x/auction/keeper"
	auctiontypes "github.com/Gert-Chain/core/x/auction/types"
	"github.com/Gert-Chain/core/x/bep3"
	bep3keeper "github.com/Gert-Chain/core/x/bep3/keeper"
	bep3types "github.com/Gert-Chain/core/x/bep3/types"
	"github.com/Gert-Chain/core/x/cdp"
	cdpkeeper "github.com/Gert-Chain/core/x/cdp/keeper"
	cdptypes "github.com/Gert-Chain/core/x/cdp/types"
	"github.com/Gert-Chain/core/x/committee"
	committeeclient "github.com/Gert-Chain/core/x/committee/client"
	committeekeeper "github.com/Gert-Chain/core/x/committee/keeper"
	committeetypes "github.com/Gert-Chain/core/x/committee/types"
	evmutil "github.com/Gert-Chain/core/x/evmutil"
	evmutilkeeper "github.com/Gert-Chain/core/x/evmutil/keeper"
	evmutiltypes "github.com/Gert-Chain/core/x/evmutil/types"
	"github.com/Gert-Chain/core/x/gertdist"
	gertdistclient "github.com/Gert-Chain/core/x/gertdist/client"
	gertdistkeeper "github.com/Gert-Chain/core/x/gertdist/keeper"
	gertdisttypes "github.com/Gert-Chain/core/x/gertdist/types"
	"github.com/Gert-Chain/core/x/hard"
	hardkeeper "github.com/Gert-Chain/core/x/hard/keeper"
	hardtypes "github.com/Gert-Chain/core/x/hard/types"
	"github.com/Gert-Chain/core/x/incentive"
	incentivekeeper "github.com/Gert-Chain/core/x/incentive/keeper"
	incentivetypes "github.com/Gert-Chain/core/x/incentive/types"
	issuance "github.com/Gert-Chain/core/x/issuance"
	issuancekeeper "github.com/Gert-Chain/core/x/issuance/keeper"
	issuancetypes "github.com/Gert-Chain/core/x/issuance/types"
	pricefeed "github.com/Gert-Chain/core/x/pricefeed"
	pricefeedkeeper "github.com/Gert-Chain/core/x/pricefeed/keeper"
	pricefeedtypes "github.com/Gert-Chain/core/x/pricefeed/types"
	savings "github.com/Gert-Chain/core/x/savings"
	savingskeeper "github.com/Gert-Chain/core/x/savings/keeper"
	savingstypes "github.com/Gert-Chain/core/x/savings/types"
	"github.com/Gert-Chain/core/x/swap"
	swapkeeper "github.com/Gert-Chain/core/x/swap/keeper"
	swaptypes "github.com/Gert-Chain/core/x/swap/types"
	validatorvesting "github.com/Gert-Chain/core/x/validator-vesting"
	validatorvestingtypes "github.com/Gert-Chain/core/x/validator-vesting/types"
)
...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		gov.NewAppModuleBasic(
			...
			gertdistclient.ProposalHandler,
	...
	mAccPerms = map[string][]string{
		...
		gertdisttypes.gertDistMacc:      {authtypes.Minter},
...
// App is the gert ABCI application.
type App struct {
	*baseapp.BaseApp
	...
	gertdistKeeper   gertdistkeeper.Keeper
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".gert")
}
...
func NewApp(
	...
	encodingConfig gertparams.EncodingConfig,
	options Options,
	...
	keys := sdk.NewKVStoreKeys(
		...
		capabilitytypes.StoreKey, gertdisttypes.StoreKey, auctiontypes.StoreKey,
	...
	gertdistSubspace := app.paramsKeeper.Subspace(gertdisttypes.ModuleName)
	...
	app.gertdistKeeper = gertdistkeeper.NewKeeper(
		appCodec,
		keys[gertdisttypes.StoreKey],
		gertdistSubspace,
		app.bankKeeper,
		app.accountKeeper,
		app.distrKeeper,
	...
	govRouter.
		...
		AddRoute(distrtypes.RouterKey, distr.NewCommunityPoolSpendProposalHandler(app.distrKeeper)).
		AddRoute(gertdisttypes.RouterKey, gertdist.NewCommunityPoolMultiSpendProposalHandler(app.gertdistKeeper)).
	...
	app.mm = module.NewManager(
		...
		gertdist.NewAppModule(app.gertdistKeeper, app.accountKeeper),
...
func (app *App) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
	...
	// Store current module versions in gert-10 to setup future in-place upgrades.
...
func (app *App) loadBlockedMaccAddrs() map[string]bool {
	...
	gertdistMaccAddr := app.accountKeeper.GetModuleAddress(gertdisttypes.ModuleName)
	for addr := range modAccAddrs {
		// Set the gertdist module account address as unblocked
		if addr == gertdistMaccAddr.String() {
