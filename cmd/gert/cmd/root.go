...
import (
	...
	gertclient "github.com/Gert-Chain/core/client"
	"github.com/Gert-Chain/core/migrate"
)

// EnvPrefix is the prefix environment variables must have to configure the app.
const EnvPrefix = "gert"

// NewRootCmd creates a new root command for the gert blockchain.
func NewRootCmd() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		Use:   "gert",
		Short: "Daemon and CLI for the gert blockchain.",
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			customAppTemplate, customAppConfig := servercfg.AppConfig("ugert")
...
// addSubCmds registers all the sub commands used by gert.
func addSubCmds(rootCmd *cobra.Command, encodingConfig params.EncodingConfig, defaultNodeHome string) {
	...
	rootCmd.AddCommand(
		...
		newQueryCmd(),
		newTxCmd(),
		gertclient.KeyCommands(app.DefaultNodeHome),
	)
}
