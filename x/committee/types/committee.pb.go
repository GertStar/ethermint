...
// source: gert/committee/v1beta1/committee.proto
...
type BaseCommittee struct {
	...
	TallyOption      TallyOption   `protobuf:"varint,7,opt,name=tally_option,json=tallyOption,proto3,enum=gert.committee.v1beta1.TallyOption" json:"tally_option,omitempty"`
}
...
func init() {
	proto.RegisterEnum("gert.committee.v1beta1.TallyOption", TallyOption_name, TallyOption_value)
	proto.RegisterType((*BaseCommittee)(nil), "gert.committee.v1beta1.BaseCommittee")
	proto.RegisterType((*MemberCommittee)(nil), "gert.committee.v1beta1.MemberCommittee")
	proto.RegisterType((*TokenCommittee)(nil), "gert.committee.v1beta1.TokenCommittee")
}

func init() {
	proto.RegisterFile("gert/committee/v1beta1/committee.proto", fileDescriptor_a2549fd9d70ca349)
}
