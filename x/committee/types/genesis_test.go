...
import (
	...
	"github.com/Gert-Chain/core/x/committee/testutil"
	"github.com/Gert-Chain/core/x/committee/types"
)
...
func TestGenesisState_Validate(t *testing.T) {
	...
	addresses := []sdk.AccAddress{
		...
		sdk.AccAddress(crypto.AddressHash([]byte("gertTest3"))),
		sdk.AccAddress(crypto.AddressHash([]byte("gertTest4"))),
		sdk.AccAddress(crypto.AddressHash([]byte("gertTest5"))),
	}
