...
// source: gert/committee/v1beta1/genesis.proto
...
func init() {
	proto.RegisterEnum("gert.committee.v1beta1.VoteType", VoteType_name, VoteType_value)
	proto.RegisterType((*GenesisState)(nil), "gert.committee.v1beta1.GenesisState")
	proto.RegisterType((*Proposal)(nil), "gert.committee.v1beta1.Proposal")
	proto.RegisterType((*Vote)(nil), "gert.committee.v1beta1.Vote")
}

func init() {
	proto.RegisterFile("gert/committee/v1beta1/genesis.proto", fileDescriptor_919b27ac60d8c5fd)
}
