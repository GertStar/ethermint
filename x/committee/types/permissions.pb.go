...
// source: gert/committee/v1beta1/permissions.proto
...
func init() {
	proto.RegisterType((*GodPermission)(nil), "gert.committee.v1beta1.GodPermission")
	proto.RegisterType((*SoftwareUpgradePermission)(nil), "gert.committee.v1beta1.SoftwareUpgradePermission")
	proto.RegisterType((*TextPermission)(nil), "gert.committee.v1beta1.TextPermission")
	proto.RegisterType((*ParamsChangePermission)(nil), "gert.committee.v1beta1.ParamsChangePermission")
	proto.RegisterType((*AllowedParamsChange)(nil), "gert.committee.v1beta1.AllowedParamsChange")
	proto.RegisterType((*SubparamRequirement)(nil), "gert.committee.v1beta1.SubparamRequirement")
}

func init() {
	proto.RegisterFile("gert/committee/v1beta1/permissions.proto", fileDescriptor_bdfaf7be16465ae4)
}
