...
const (
	BaseCommitteeType   = "gert/BaseCommittee"
	MemberCommitteeType = "gert/MemberCommittee" // Committee is composed of member addresses that vote to enact proposals within their permissions
	TokenCommitteeType  = "gert/TokenCommittee"  // Committee is composed of token holders with voting power determined by total token balance
	BondDenom           = "ugert"
)
...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(BaseCommittee{}, "gert/BaseCommittee")
	govtypes.RegisterProposalTypeCodec(MemberCommittee{}, "gert/MemberCommittee")
	govtypes.RegisterProposalTypeCodec(TokenCommittee{}, "gert/TokenCommittee")
}
