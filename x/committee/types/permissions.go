...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(GodPermission{}, "gert/GodPermission")
	govtypes.RegisterProposalTypeCodec(TextPermission{}, "gert/TextPermission")
	govtypes.RegisterProposalTypeCodec(SoftwareUpgradePermission{}, "gert/SoftwareUpgradePermission")
	govtypes.RegisterProposalTypeCodec(ParamsChangePermission{}, "gert/ParamsChangePermission")
}
