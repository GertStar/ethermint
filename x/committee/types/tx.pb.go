...
// source: gert/committee/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgSubmitProposal)(nil), "gert.committee.v1beta1.MsgSubmitProposal")
	proto.RegisterType((*MsgSubmitProposalResponse)(nil), "gert.committee.v1beta1.MsgSubmitProposalResponse")
	proto.RegisterType((*MsgVote)(nil), "gert.committee.v1beta1.MsgVote")
	proto.RegisterType((*MsgVoteResponse)(nil), "gert.committee.v1beta1.MsgVoteResponse")
}

func init() { proto.RegisterFile("gert/committee/v1beta1/tx.proto", fileDescriptor_3f3857845b071606) }
...
func (c *msgClient) SubmitProposal(ctx context.Context, in *MsgSubmitProposal, opts ...grpc.CallOption) (*MsgSubmitProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.committee.v1beta1.Msg/SubmitProposal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Vote(ctx context.Context, in *MsgVote, opts ...grpc.CallOption) (*MsgVoteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.committee.v1beta1.Msg/Vote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SubmitProposal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.committee.v1beta1.Msg/SubmitProposal",
	}
...
func _Msg_Vote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.committee.v1beta1.Msg/Vote",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "gert.committee.v1beta1.Msg",
	...
	Metadata: "gert/committee/v1beta1/tx.proto",
}
