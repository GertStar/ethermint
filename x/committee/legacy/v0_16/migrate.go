...
import (
	...
	v016bep3types "github.com/Gert-Chain/core/x/bep3/types"
	v016cdptypes "github.com/Gert-Chain/core/x/cdp/types"
	v015committee "github.com/Gert-Chain/core/x/committee/legacy/v0_15"
	v016committee "github.com/Gert-Chain/core/x/committee/types"
	v015gertdist "github.com/Gert-Chain/core/x/gertdist/legacy/v0_15"
	v016gertdist "github.com/Gert-Chain/core/x/gertdist/types"
	v016hardMigration "github.com/Gert-Chain/core/x/hard/legacy/v0_16"
	v016hardtypes "github.com/Gert-Chain/core/x/hard/types"
	v015pricefeed "github.com/Gert-Chain/core/x/pricefeed/legacy/v0_15"
	v016pricefeedmigration "github.com/Gert-Chain/core/x/pricefeed/legacy/v0_16"
	v016pricefeedtypes "github.com/Gert-Chain/core/x/pricefeed/types"
)

const (
	gertStabilityCommitteeID  = 1
...
func migrateSubParamPermissions(
	...
	if isSubparamAllowed(permission, v016cdptypes.ModuleName, string(v016cdptypes.KeyCollateralParams)) {
		...
		if committeeID == gertStabilityCommitteeID {
			requirement := v016committee.SubparamRequirement{
				Key: "type",
				Val: "swp-a",
				AllowedSubparamAttrChanges: []string{
...
func migrateContent(oldContent v036gov.Content) *codectypes.Any {
	...
	case v015gertdist.CommunityPoolMultiSpendProposal:
		{
			newRecipients := make([]v016gertdist.MultiSpendRecipient, len(oldContent.RecipientList))
			for i, recipient := range oldContent.RecipientList {
				newRecipients[i] = v016gertdist.MultiSpendRecipient{
					Address: recipient.Address.String(),
					Amount:  recipient.Amount,
				}
			}

			protoProposal = &v016gertdist.CommunityPoolMultiSpendProposal{
				Description:   oldContent.Description,
				Title:         oldContent.Title,
