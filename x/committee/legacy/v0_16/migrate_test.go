...
func (s *migrateTestSuite) SetupTest() {
	...
	v015gertdist.RegisterLegacyAminoCodec(legacyCodec)
	...
	testcases := []struct {
		...
		},
		{
			...
			v015proposal: v036distr.CommunityPoolSpendProposal{
				...
				Amount:      sdk.NewCoins(sdk.NewInt64Coin("ugert", 10)),
			},
		...
		{
			name: "gertdist community pool multi spend proposal",
			v015proposal: v015gertdist.CommunityPoolMultiSpendProposal{
				Title:       "Test",
				Description: "Test",
				RecipientList: v015gertdist.MultiSpendRecipients{
					v015gertdist.MultiSpendRecipient{
						Address: s.addresses[0],
						Amount:  sdk.NewCoins(sdk.NewInt64Coin("ugert", 10)),
					},
				},
			},
			v016proposal: &v016gertdist.CommunityPoolMultiSpendProposal{
				Title:       "Test",
				Description: "Test",
				RecipientList: []v016gertdist.MultiSpendRecipient{
					{
