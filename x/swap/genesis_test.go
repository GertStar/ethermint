...
func (suite *genesisTestSuite) Test_InitAndExportGenesis() {
	...
	state := types.NewGenesisState(
		types.Params{
			AllowedPools: types.AllowedPools{types.NewAllowedPool("ugert", "usdx")},
		...
		types.PoolRecords{
			...
			types.NewPoolRecord(sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(1e6)), sdk.NewCoin("usdx", sdk.NewInt(5e6))), sdk.NewInt(3e6)),
		},
		types.ShareRecords{
			types.NewShareRecord(depositor_2, types.PoolID("hard", "usdx"), sdk.NewInt(1e6)),
			types.NewShareRecord(depositor_1, types.PoolID("ugert", "usdx"), sdk.NewInt(3e6)),
		},
	)
	...
	poolRecord2, _ := suite.Keeper.GetPool(suite.Ctx, types.PoolID("ugert", "usdx"))
	...
	shareRecord2, _ := suite.Keeper.GetDepositorShares(suite.Ctx, depositor_1, types.PoolID("ugert", "usdx"))
