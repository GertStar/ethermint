...
func queryDepositsCmd(queryRoute string) *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: strings.TrimSpace(`get liquidity provider deposits:
 		...
 		$ kvcli q swap deposits --owner gert1l0xsq2z7gqd7yly0g40y5836g0appumark77ny
 		$ kvcli q swap deposits --pool bnb:usdx --owner gert1l0xsq2z7gqd7yly0g40y5836g0appumark77ny
