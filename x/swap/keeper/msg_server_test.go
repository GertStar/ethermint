...
import (
	...
	"github.com/Gert-Chain/core/x/swap/keeper"
	"github.com/Gert-Chain/core/x/swap/testutil"
...
func (suite *msgServerTestSuite) TestDeposit_ExistingPool() {
	...
	deposit := types.NewMsgDeposit(
		...
		suite.BankKeeper.GetBalance(suite.Ctx, depositor.GetAddress(), "ugert"),
		sdk.MustNewDecFromStr("0.01"),
		time.Now().Add(10*time.Minute).Unix(),
	)
...
func (suite *msgServerTestSuite) TestWithdraw_AllShares() {
	...
	suite.PoolDeleted("ugert", "usdx")
	suite.PoolSharesDeleted(depositor.GetAddress(), "ugert", "usdx")
...
func (suite *msgServerTestSuite) TestWithdraw_PartialShares() {
	...
	minTokenA := sdk.NewCoin("ugert", sdk.NewInt(4999999))
	...
	suite.PoolShareValueEqual(depositor, types.NewAllowedPool("ugert", "usdx"), reserves.Sub(expectedCoinsReceived))
...
func (suite *msgServerTestSuite) TestWithdraw_SlippageFailure() {
	...
	minTokenA := sdk.NewCoin("ugert", sdk.NewInt(5e6))
...
func (suite *msgServerTestSuite) TestSwapExactForTokens() {
	...
	swapInput := sdk.NewCoin("ugert", sdk.NewInt(1e6))
	...
	suite.EventsContains(suite.GetEvents(), sdk.NewEvent(
		...
		sdk.NewAttribute(types.AttributeKeyPoolID, types.PoolID("ugert", "usdx")),
		...
		sdk.NewAttribute(types.AttributeKeyFeePaid, "3000ugert"),
...
func (suite *msgServerTestSuite) TestSwapForExactTokens() {
	...
	expectedSwapInput := sdk.NewCoin("ugert", sdk.NewInt(1004015))
	...
	suite.EventsContains(suite.GetEvents(), sdk.NewEvent(
		...
		sdk.NewAttribute(types.AttributeKeyFeePaid, "3013ugert"),
...
func (suite *msgServerTestSuite) TestSwapForExactTokens_SlippageFailure() {
	...
	swapMsg := types.NewMsgSwapForExactTokens(
		requester.GetAddress().String(),
		sdk.NewCoin("ugert", sdk.NewInt(990991)),
		swapOutput,
		sdk.MustNewDecFromStr("0.01"),
		time.Now().Add(10*time.Minute).Unix(),
	)
