...
func (suite keeperTestSuite) TestParams_Persistance() {
	...
	params = types.Params{
		AllowedPools: types.AllowedPools{
			types.NewAllowedPool("hard", "ugert"),
		},
...
func (suite *keeperTestSuite) TestPool_PanicsWhenInvalid() {
	invalidRecord := types.NewPoolRecord(
		sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(100e6)), sdk.NewCoin("usdx", sdk.NewInt(100e6))),
		i(-1),
	)
...
func (suite *keeperTestSuite) TestShare_Persistance() {
	...
	depositor, err := sdk.AccAddressFromBech32("gert1skpsgk5cnrarn69ql2tfun47fyjssataz0g07l")
	suite.NoError(err)
...
func (suite *keeperTestSuite) TestHooks() {
	...
	suite.Keeper.AfterPoolDepositCreated(suite.Ctx, "ugert/usdx", depositor, sdk.NewInt(1e6))
	suite.Keeper.BeforePoolDepositModified(suite.Ctx, "ugert/usdx", depositor, sdk.NewInt(1e6))
	...
	swapHooks.On("AfterPoolDepositCreated", suite.Ctx, "ugert/usdx", depositor, sdk.NewInt(1e6)).Once()
	suite.Keeper.AfterPoolDepositCreated(suite.Ctx, "ugert/usdx", depositor, sdk.NewInt(1e6))
	swapHooks.On("BeforePoolDepositModified", suite.Ctx, "ugert/usdx", depositor, sdk.NewInt(1e6)).Once()
	suite.Keeper.BeforePoolDepositModified(suite.Ctx, "ugert/usdx", depositor, sdk.NewInt(1e6))
