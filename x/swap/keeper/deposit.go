...
//
// For example, if we have a pool with 100e6 ugert and 400e6 usdx.  The ugert price is 4 usdx and the
// usdx price is 0.25 ugert.  If a depositor adds liquidity of 4e6 ugert and 14e6 usdx, a gert price of
// 3.50 usdx and a usdx price of 0.29 ugert.  This is a -12.5% slippage is the ugert price, and a 14.3%
