...
// source: gert/swap/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "gert.swap.v1beta1.GenesisState")
}

func init() { proto.RegisterFile("gert/swap/v1beta1/genesis.proto", fileDescriptor_b1a1a1687f484a21) }
