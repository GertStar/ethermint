...
// source: gert/swap/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgDeposit)(nil), "gert.swap.v1beta1.MsgDeposit")
	proto.RegisterType((*MsgDepositResponse)(nil), "gert.swap.v1beta1.MsgDepositResponse")
	proto.RegisterType((*MsgWithdraw)(nil), "gert.swap.v1beta1.MsgWithdraw")
	proto.RegisterType((*MsgWithdrawResponse)(nil), "gert.swap.v1beta1.MsgWithdrawResponse")
	proto.RegisterType((*MsgSwapExactForTokens)(nil), "gert.swap.v1beta1.MsgSwapExactForTokens")
	proto.RegisterType((*MsgSwapExactForTokensResponse)(nil), "gert.swap.v1beta1.MsgSwapExactForTokensResponse")
	proto.RegisterType((*MsgSwapForExactTokens)(nil), "gert.swap.v1beta1.MsgSwapForExactTokens")
	proto.RegisterType((*MsgSwapForExactTokensResponse)(nil), "gert.swap.v1beta1.MsgSwapForExactTokensResponse")
}

func init() { proto.RegisterFile("gert/swap/v1beta1/tx.proto", fileDescriptor_5b753029ccc8a1ef) }
...
func (c *msgClient) Deposit(ctx context.Context, in *MsgDeposit, opts ...grpc.CallOption) (*MsgDepositResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.swap.v1beta1.Msg/Deposit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Withdraw(ctx context.Context, in *MsgWithdraw, opts ...grpc.CallOption) (*MsgWithdrawResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.swap.v1beta1.Msg/Withdraw", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SwapExactForTokens(ctx context.Context, in *MsgSwapExactForTokens, opts ...grpc.CallOption) (*MsgSwapExactForTokensResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.swap.v1beta1.Msg/SwapExactForTokens", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SwapForExactTokens(ctx context.Context, in *MsgSwapForExactTokens, opts ...grpc.CallOption) (*MsgSwapForExactTokensResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.swap.v1beta1.Msg/SwapForExactTokens", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Deposit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.swap.v1beta1.Msg/Deposit",
	}
...
func _Msg_Withdraw_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.swap.v1beta1.Msg/Withdraw",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_SwapExactForTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.swap.v1beta1.Msg/SwapExactForTokens",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_SwapForExactTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.swap.v1beta1.Msg/SwapForExactTokens",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "gert.swap.v1beta1.Msg",
	...
	Metadata: "gert/swap/v1beta1/tx.proto",
}
