...
// source: gert/bep3/v1beta1/query.proto
...
type AtomicSwapResponse struct {
	...
	// sender is the gert chain sender of the swap
	Sender string `protobuf:"bytes,6,opt,name=sender,proto3" json:"sender,omitempty"`
	// recipient is the gert chain recipient of the swap
	...
	Status SwapStatus `protobuf:"varint,11,opt,name=status,proto3,enum=gert.bep3.v1beta1.SwapStatus" json:"status,omitempty"`
	...
	Direction SwapDirection `protobuf:"varint,13,opt,name=direction,proto3,enum=gert.bep3.v1beta1.SwapDirection" json:"direction,omitempty"`
}
...
type QueryAtomicSwapsRequest struct {
	...
	Status SwapStatus `protobuf:"varint,3,opt,name=status,proto3,enum=gert.bep3.v1beta1.SwapStatus" json:"status,omitempty"`
	// direction fitlers by swap direction
	Direction  SwapDirection      `protobuf:"varint,4,opt,name=direction,proto3,enum=gert.bep3.v1beta1.SwapDirection" json:"direction,omitempty"`
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "gert.bep3.v1beta1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "gert.bep3.v1beta1.QueryParamsResponse")
	proto.RegisterType((*QueryAssetSupplyRequest)(nil), "gert.bep3.v1beta1.QueryAssetSupplyRequest")
	proto.RegisterType((*AssetSupplyResponse)(nil), "gert.bep3.v1beta1.AssetSupplyResponse")
	proto.RegisterType((*QueryAssetSupplyResponse)(nil), "gert.bep3.v1beta1.QueryAssetSupplyResponse")
	proto.RegisterType((*QueryAssetSuppliesRequest)(nil), "gert.bep3.v1beta1.QueryAssetSuppliesRequest")
	proto.RegisterType((*QueryAssetSuppliesResponse)(nil), "gert.bep3.v1beta1.QueryAssetSuppliesResponse")
	proto.RegisterType((*QueryAtomicSwapRequest)(nil), "gert.bep3.v1beta1.QueryAtomicSwapRequest")
	proto.RegisterType((*QueryAtomicSwapResponse)(nil), "gert.bep3.v1beta1.QueryAtomicSwapResponse")
	proto.RegisterType((*AtomicSwapResponse)(nil), "gert.bep3.v1beta1.AtomicSwapResponse")
	proto.RegisterType((*QueryAtomicSwapsRequest)(nil), "gert.bep3.v1beta1.QueryAtomicSwapsRequest")
	proto.RegisterType((*QueryAtomicSwapsResponse)(nil), "gert.bep3.v1beta1.QueryAtomicSwapsResponse")
}

func init() { proto.RegisterFile("gert/bep3/v1beta1/query.proto", fileDescriptor_a5e4082d53c18bf6) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.bep3.v1beta1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AssetSupply(ctx context.Context, in *QueryAssetSupplyRequest, opts ...grpc.CallOption) (*QueryAssetSupplyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.bep3.v1beta1.Query/AssetSupply", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AssetSupplies(ctx context.Context, in *QueryAssetSuppliesRequest, opts ...grpc.CallOption) (*QueryAssetSuppliesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.bep3.v1beta1.Query/AssetSupplies", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AtomicSwap(ctx context.Context, in *QueryAtomicSwapRequest, opts ...grpc.CallOption) (*QueryAtomicSwapResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.bep3.v1beta1.Query/AtomicSwap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AtomicSwaps(ctx context.Context, in *QueryAtomicSwapsRequest, opts ...grpc.CallOption) (*QueryAtomicSwapsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.bep3.v1beta1.Query/AtomicSwaps", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.bep3.v1beta1.Query/Params",
	}
...
func _Query_AssetSupply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.bep3.v1beta1.Query/AssetSupply",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_AssetSupplies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.bep3.v1beta1.Query/AssetSupplies",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_AtomicSwap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.bep3.v1beta1.Query/AtomicSwap",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_AtomicSwaps_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.bep3.v1beta1.Query/AtomicSwaps",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "gert.bep3.v1beta1.Query",
	...
	Metadata: "gert/bep3/v1beta1/query.proto",
}
