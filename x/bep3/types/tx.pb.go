...
// source: gert/bep3/v1beta1/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreateAtomicSwap)(nil), "gert.bep3.v1beta1.MsgCreateAtomicSwap")
	proto.RegisterType((*MsgCreateAtomicSwapResponse)(nil), "gert.bep3.v1beta1.MsgCreateAtomicSwapResponse")
	proto.RegisterType((*MsgClaimAtomicSwap)(nil), "gert.bep3.v1beta1.MsgClaimAtomicSwap")
	proto.RegisterType((*MsgClaimAtomicSwapResponse)(nil), "gert.bep3.v1beta1.MsgClaimAtomicSwapResponse")
	proto.RegisterType((*MsgRefundAtomicSwap)(nil), "gert.bep3.v1beta1.MsgRefundAtomicSwap")
	proto.RegisterType((*MsgRefundAtomicSwapResponse)(nil), "gert.bep3.v1beta1.MsgRefundAtomicSwapResponse")
}

func init() { proto.RegisterFile("gert/bep3/v1beta1/tx.proto", fileDescriptor_019a1c7100544f13) }
...
func (c *msgClient) CreateAtomicSwap(ctx context.Context, in *MsgCreateAtomicSwap, opts ...grpc.CallOption) (*MsgCreateAtomicSwapResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.bep3.v1beta1.Msg/CreateAtomicSwap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ClaimAtomicSwap(ctx context.Context, in *MsgClaimAtomicSwap, opts ...grpc.CallOption) (*MsgClaimAtomicSwapResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.bep3.v1beta1.Msg/ClaimAtomicSwap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RefundAtomicSwap(ctx context.Context, in *MsgRefundAtomicSwap, opts ...grpc.CallOption) (*MsgRefundAtomicSwapResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.bep3.v1beta1.Msg/RefundAtomicSwap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateAtomicSwap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.bep3.v1beta1.Msg/CreateAtomicSwap",
	}
...
func _Msg_ClaimAtomicSwap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.bep3.v1beta1.Msg/ClaimAtomicSwap",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RefundAtomicSwap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.bep3.v1beta1.Msg/RefundAtomicSwap",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "gert.bep3.v1beta1.Msg",
	...
	Metadata: "gert/bep3/v1beta1/tx.proto",
}
