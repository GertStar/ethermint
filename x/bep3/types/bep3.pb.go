...
// source: gert/bep3/v1beta1/bep3.proto
...
const (
	...
	// SWAP_DIRECTION_INCOMING represents is incoming swap (to the gert chain)
	SWAP_DIRECTION_INCOMING SwapDirection = 1
	// SWAP_DIRECTION_OUTGOING represents an outgoing swap (from the gert chain)
...
type AssetParam struct {
	...
	// deputy_address the gert address of the deputy
...
type AtomicSwap struct {
	...
	Status SwapStatus `protobuf:"varint,10,opt,name=status,proto3,enum=gert.bep3.v1beta1.SwapStatus" json:"status,omitempty"`
	...
	Direction SwapDirection `protobuf:"varint,12,opt,name=direction,proto3,enum=gert.bep3.v1beta1.SwapDirection" json:"direction,omitempty"`
}
...
func init() {
	proto.RegisterEnum("gert.bep3.v1beta1.SwapStatus", SwapStatus_name, SwapStatus_value)
	proto.RegisterEnum("gert.bep3.v1beta1.SwapDirection", SwapDirection_name, SwapDirection_value)
	proto.RegisterType((*Params)(nil), "gert.bep3.v1beta1.Params")
	proto.RegisterType((*AssetParam)(nil), "gert.bep3.v1beta1.AssetParam")
	proto.RegisterType((*SupplyLimit)(nil), "gert.bep3.v1beta1.SupplyLimit")
	proto.RegisterType((*AtomicSwap)(nil), "gert.bep3.v1beta1.AtomicSwap")
	proto.RegisterType((*AssetSupply)(nil), "gert.bep3.v1beta1.AssetSupply")
}

func init() { proto.RegisterFile("gert/bep3/v1beta1/bep3.proto", fileDescriptor_01a01937d931b013) }
