...
func GetCmdCreateAtomicSwap() *cobra.Command {
	return &cobra.Command{
		...
		Example: fmt.Sprintf("%s tx %s create gert1xy7hrjy9r0algz9w3gzm8u6mrpq97kwta747gj bnb1urfermcg92dwq36572cx4xg84wpk3lfpksr5g7 bnb1uky3me9ggqypmrsvxk7ur6hqkzq7zmv4ed4ng7 now 100bnb 270 --from validator",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			from := clientCtx.GetFromAddress() // same as gert executor's deputy address
