...
const (
	...
	TestDeputy              = "gert1xy7hrjy9r0algz9w3gzm8u6mrpq97kwta747gj"
)

var (
	DenomMap  = map[int]string{0: "btc", 1: "eth", 2: "bnb", 3: "xrp", 4: "dai"}
	TestUser1 = sdk.AccAddress(crypto.AddressHash([]byte("gertTestUser1")))
	TestUser2 = sdk.AccAddress(crypto.AddressHash([]byte("gertTestUser2")))
)
