...
import (
	...
	"github.com/Gert-Chain/core/x/savings/keeper"
	"github.com/Gert-Chain/core/x/savings/types"
)
...
func (suite *invariantTestSuite) SetupValidState() {
	depositAmt := sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(2e8)))
...
func (suite *invariantTestSuite) TestSolvencyInvariant() {
	...
	suite.keeper.SetDeposit(suite.ctx, types.NewDeposit(
		suite.addrs[0],
		sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(3e8))),
	))
	...
	suite.keeper.SetDeposit(suite.ctx, types.NewDeposit(
		suite.addrs[0],
		sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(1e8))),
	))
