...
// source: gert/savings/v1beta1/store.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "gert.savings.v1beta1.Params")
	proto.RegisterType((*Deposit)(nil), "gert.savings.v1beta1.Deposit")
}

func init() { proto.RegisterFile("gert/savings/v1beta1/store.proto", fileDescriptor_f7110366fa182786) }
