...
// source: gert/savings/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "gert.savings.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("gert/savings/v1beta1/genesis.proto", fileDescriptor_f5dcde4d417fcec8)
}
