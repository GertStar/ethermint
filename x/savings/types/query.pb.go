...
// source: gert/savings/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "gert.savings.v1beta1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "gert.savings.v1beta1.QueryParamsResponse")
	proto.RegisterType((*QueryDepositsRequest)(nil), "gert.savings.v1beta1.QueryDepositsRequest")
	proto.RegisterType((*QueryDepositsResponse)(nil), "gert.savings.v1beta1.QueryDepositsResponse")
}

func init() { proto.RegisterFile("gert/savings/v1beta1/query.proto", fileDescriptor_f78c91efc5db144f) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.savings.v1beta1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Deposits(ctx context.Context, in *QueryDepositsRequest, opts ...grpc.CallOption) (*QueryDepositsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.savings.v1beta1.Query/Deposits", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.savings.v1beta1.Query/Params",
	}
...
func _Query_Deposits_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.savings.v1beta1.Query/Deposits",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "gert.savings.v1beta1.Query",
	...
	Metadata: "gert/savings/v1beta1/query.proto",
}
