...
// source: gert/evmutil/v1beta1/genesis.proto
...
type Account struct {
	...
	// balance indicates the amount of agert owned by the address.
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "gert.evmutil.v1beta1.GenesisState")
	proto.RegisterType((*Account)(nil), "gert.evmutil.v1beta1.Account")
}

func init() {
	proto.RegisterFile("gert/evmutil/v1beta1/genesis.proto", fileDescriptor_d916ab97b8e628c2)
}
