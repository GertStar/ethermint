...
import (
	...
	"github.com/Gert-Chain/core/x/cdp/keeper"
...
func (suite *SeizeTestSuite) SetupTest() {
	tApp := app.NewTestApp()
	ctx := tApp.NewContext(true, tmproto.Header{Height: 1, Time: tmtime.Now(), ChainID: "gerttest_1-1"})
...
func (suite *SeizeTestSuite) TestKeeperLiquidation() {
	...
	addr, _ := sdk.AccAddressFromBech32("gert1ze7y9qwdddejmy7jlw4cymqqlt2wh05yhwmrv2")
