...
// source: gert/cdp/v1beta1/cdp.proto
...
func init() {
	proto.RegisterType((*CDP)(nil), "gert.cdp.v1beta1.CDP")
	proto.RegisterType((*Deposit)(nil), "gert.cdp.v1beta1.Deposit")
	proto.RegisterType((*TotalPrincipal)(nil), "gert.cdp.v1beta1.TotalPrincipal")
	proto.RegisterType((*TotalCollateral)(nil), "gert.cdp.v1beta1.TotalCollateral")
	proto.RegisterType((*OwnerCDPIndex)(nil), "gert.cdp.v1beta1.OwnerCDPIndex")
}

func init() { proto.RegisterFile("gert/cdp/v1beta1/cdp.proto", fileDescriptor_68a9ab097fb7be40) }
