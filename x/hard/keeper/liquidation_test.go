...
import (
	...
	auctiontypes "github.com/Gert-Chain/core/x/auction/types"
	"github.com/Gert-Chain/core/x/hard"
	"github.com/Gert-Chain/core/x/hard/types"
	pricefeedtypes "github.com/Gert-Chain/core/x/pricefeed/types"
)
	...
	testCases := []liqTest{
		{
			...
			args{
				...
				initialModuleCoins:         sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(100*gert_CF))),
				initialBorrowerCoins:       sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(100*gert_CF))),
				initialKeeperCoins:         sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(100*gert_CF))),
				depositCoins:               sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(10*gert_CF))),
				borrowCoins:                sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(8*gert_CF))),
				liquidateAfter:             oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(sdk.NewInt64Coin("ugert", 100004118)),
				expectedTotalBorrowedCoins: nil,
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(100500020))),
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(98000001))), // initial - deposit + borrow + liquidation leftovers
				expectedAuctions: []auctiontypes.Auction{
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              1,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ugert", 9500390),
							Bidder:          sdk.AccAddress(nil),
							Bid:             sdk.NewInt64Coin("ugert", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
							MaxEndTime:      endTime,
						},
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("ugert", 8004766),
		...
		},
		{
			...
			args{
				...
				borrowCoins:                sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(8*gert_CF))),
				liquidateAfter:             oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(sdk.NewInt64Coin("ugert", 100_004_117)),
				expectedTotalBorrowedCoins: sdk.NewCoins(sdk.NewInt64Coin("ugert", 1)),
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(100*gert_CF))),
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(98*gert_CF))), // initial - deposit + borrow + liquidation leftovers
				expectedAuctions: []auctiontypes.Auction{
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              1,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ugert", 10000411),
							Bidder:          sdk.AccAddress(nil),
							Bid:             sdk.NewInt64Coin("ugert", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("ugert", 8004765),
						LotReturns:        lotReturns,
					},
				},
			},
		...
		},
		{
			...
			args{
				...
				liquidateAfter:             oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(sdk.NewInt64Coin("ugert", 100_004_117)),
				expectedTotalBorrowedCoins: sdk.NewCoins(sdk.NewInt64Coin("ugert", 8_004_766)),
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(110_000_411))),
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(98*gert_CF))), // initial - deposit + borrow + liquidation leftovers
		...
		},
		{
			...
			args{
				...
				keeper:               keeper,
				keeperRewardPercent:  sdk.MustNewDecFromStr("0.05"),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(1000*gert_CF)), sdk.NewCoin("usdc", sdk.NewInt(1000*gert_CF)), sdk.NewCoin("bnb", sdk.NewInt(1000*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(1000*BTCB_CF))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(100*gert_CF))),
				initialKeeperCoins:   sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(100*gert_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(50*gert_CF))),                                                                                                                                     // $100 * 0.8 = $80 borrowable
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("usdc", sdk.NewInt(20*gert_CF)), sdk.NewCoin("ugert", sdk.NewInt(10*gert_CF)), sdk.NewCoin("bnb", sdk.NewInt(2*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(0.2*BTCB_CF))), // $20+$20+$20 = $80 borrowed
				liquidateAfter:       oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(
					sdk.NewInt64Coin("ugert", 1000000710),
					sdk.NewInt64Coin("usdc", 1000003120),
					sdk.NewInt64Coin("bnb", 100000003123),
					sdk.NewInt64Coin("btc", 100000000031),
				),
				expectedTotalBorrowedCoins: nil,
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(102500001))),
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("usdc", sdk.NewInt(20*gert_CF)), sdk.NewCoin("ugert", sdk.NewInt(60000002)), sdk.NewCoin("bnb", sdk.NewInt(2*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(0.2*BTCB_CF))), // initial - deposit + borrow + liquidation leftovers
				expectedAuctions: []auctiontypes.Auction{
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              1,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ugert", 11874430),
							Bidder:          sdk.AccAddress(nil),
					...
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              2,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ugert", 11874254),
							Bidder:          sdk.AccAddress(nil),
					...
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              3,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ugert", 11875163),
							Bidder:          sdk.AccAddress(nil),
							Bid:             sdk.NewInt64Coin("ugert", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("ugert", 10000782),
						LotReturns:        lotReturns,
					},
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              4,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ugert", 11876185),
							Bidder:          sdk.AccAddress(nil),
		...
		},
		{
			...
			args{
				...
				keeper:               keeper,
				keeperRewardPercent:  sdk.MustNewDecFromStr("0.05"),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(1000*gert_CF))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(100*gert_CF)), sdk.NewCoin("bnb", sdk.NewInt(100*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(100*BTCB_CF))),
				initialKeeperCoins:   sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(100*gert_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(50*gert_CF)), sdk.NewCoin("bnb", sdk.NewInt(10*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(1*BTCB_CF))), // $100 + $100 + $100 = $300 * 0.8 = $240 borrowable                                                                                                                                       // $100 * 0.8 = $80 borrowable
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(120*gert_CF))),                                                                                      // $240 borrowed
				liquidateAfter:       oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(
					sdk.NewInt64Coin("ugert", 1000101456),
				),
				expectedTotalBorrowedCoins: nil,
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(102500253)), sdk.NewCoin("bnb", sdk.NewInt(0.5*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(0.05*BTCB_CF))), // 5% of each seized coin + initial balances
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(170.000001*gert_CF)), sdk.NewCoin("bnb", sdk.NewInt(90*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(99*BTCB_CF))),
				expectedAuctions: []auctiontypes.Auction{
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              1,
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("ugert", 40036023),
						LotReturns:        lotReturns,
					},
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
					...
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              3,
							Initiator:       "hard",
							Lot:             sdk.NewInt64Coin("ugert", 47504818),
							Bidder:          sdk.AccAddress(nil),
							Bid:             sdk.NewInt64Coin("ugert", 0),
							HasReceivedBids: false,
							EndTime:         endTime,
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("ugert", 40040087),
						LotReturns:        lotReturns,
					},
				},
			},
		...
		},
		{
			...
			args{
				...
				keeper:               keeper,
				keeperRewardPercent:  sdk.MustNewDecFromStr("0.05"),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(1000*gert_CF)), sdk.NewCoin("bnb", sdk.NewInt(1000*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(1000*BTCB_CF))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(100*gert_CF)), sdk.NewCoin("usdc", sdk.NewInt(100*gert_CF)), sdk.NewCoin("usdt", sdk.NewInt(100*gert_CF)), sdk.NewCoin("usdx", sdk.NewInt(100*gert_CF))),
				initialKeeperCoins:   sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(100*gert_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("usdc", sdk.NewInt(100*gert_CF)), sdk.NewCoin("usdt", sdk.NewInt(100*gert_CF)), sdk.NewCoin("usdx", sdk.NewInt(100*gert_CF))), // $100 + $100 + $100 = $300 * 0.9 = $270 borrowable
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(35*gert_CF)), sdk.NewCoin("bnb", sdk.NewInt(10*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(1*BTCB_CF))),       // $270 borrowed
				liquidateAfter:       oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(
					sdk.NewInt64Coin("bnb", 100000078047),
					sdk.NewInt64Coin("btc", 100000000780),
					sdk.NewInt64Coin("ugert", 1000009550),
					sdk.NewInt64Coin("usdx", 1),
				),
				expectedTotalBorrowedCoins: nil,
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(100*gert_CF)), sdk.NewCoin("usdc", sdk.NewInt(5*gert_CF)), sdk.NewCoin("usdt", sdk.NewInt(5*gert_CF)), sdk.NewCoin("usdx", sdk.NewInt(5*gert_CF))), // 5% of each seized coin + initial balances
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(135*gert_CF)), sdk.NewCoin("bnb", sdk.NewInt(10*BNB_CF)), sdk.NewCoin("btc", sdk.NewInt(1*BTCB_CF)), sdk.NewCoin("usdx", sdk.NewInt(0.000001*gert_CF))),
				expectedAuctions: []auctiontypes.Auction{
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              1,
					...
					&auctiontypes.CollateralAuction{
						...
						CorrespondingDebt: sdk.NewInt64Coin("debt", 0),
						MaxBid:            sdk.NewInt64Coin("ugert", 35010052), // $70.02
						LotReturns:        lotReturns,
					},
				},
			},
		...
		},
		{
			...
			args{
				...
				keeper:               keeper,
				keeperRewardPercent:  sdk.MustNewDecFromStr("0.05"),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("usdx", sdk.NewInt(1000*gert_CF)), sdk.NewCoin("usdt", sdk.NewInt(1000*gert_CF)), sdk.NewCoin("dai", sdk.NewInt(1000*gert_CF)), sdk.NewCoin("usdc", sdk.NewInt(1000*gert_CF))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("usdx", sdk.NewInt(1000*gert_CF)), sdk.NewCoin("usdt", sdk.NewInt(1000*gert_CF)), sdk.NewCoin("dai", sdk.NewInt(1000*gert_CF)), sdk.NewCoin("usdc", sdk.NewInt(1000*gert_CF))),
				initialKeeperCoins:   sdk.NewCoins(sdk.NewCoin("usdx", sdk.NewInt(1000*gert_CF)), sdk.NewCoin("usdt", sdk.NewInt(1000*gert_CF)), sdk.NewCoin("dai", sdk.NewInt(1000*gert_CF)), sdk.NewCoin("usdc", sdk.NewInt(1000*gert_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("dai", sdk.NewInt(350*gert_CF)), sdk.NewCoin("usdc", sdk.NewInt(200*gert_CF))),
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("usdt", sdk.NewInt(250*gert_CF)), sdk.NewCoin("usdx", sdk.NewInt(245*gert_CF))),
				liquidateAfter:       oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(
				...
				expectedTotalBorrowedCoins: nil,
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("dai", sdk.NewInt(1017.50*gert_CF)), sdk.NewCoin("usdt", sdk.NewInt(1000*gert_CF)), sdk.NewCoin("usdc", sdk.NewInt(1010*gert_CF)), sdk.NewCoin("usdx", sdk.NewInt(1000*gert_CF))),
				expectedBorrowerCoins:      sdk.NewCoins(sdk.NewCoin("dai", sdk.NewInt(650*gert_CF)), sdk.NewCoin("usdc", sdk.NewInt(800000001)), sdk.NewCoin("usdt", sdk.NewInt(1250*gert_CF)), sdk.NewCoin("usdx", sdk.NewInt(1245*gert_CF))),
				expectedAuctions: []auctiontypes.Auction{
					&auctiontypes.CollateralAuction{
						BaseAuction: auctiontypes.BaseAuction{
							ID:              1,
		...
		},
		{
			...
			args{
				...
				initialBorrowerCoins:       sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(100*gert_CF))),
				initialKeeperCoins:         sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(100*gert_CF))),
				depositCoins:               sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(20*gert_CF))), // Deposit 20 gert
				borrowCoins:                sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(5*gert_CF))),  // Borrow 5 gert
				liquidateAfter:             oneMonthDur,
				expectedTotalSuppliedCoins: sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(120001624))),
				expectedTotalBorrowedCoins: sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(5001709))),
				expectedKeeperCoins:        sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(100.5*gert_CF))),
			...
			hardGS := types.NewGenesisState(types.NewParams(
				types.MoneyMarkets{
					types.NewMoneyMarket("usdx",
						types.NewBorrowLimit(false, sdk.NewDec(100000000*gert_CF), sdk.MustNewDecFromStr("0.9")), // Borrow Limit
						"usdx:usd",                   // Market ID
						sdk.NewInt(gert_CF),          // Conversion Factor
					...
					types.NewMoneyMarket("dai",
						...
						reserveFactor,                // Reserve Factor
						tc.args.keeperRewardPercent), // Keeper Reward Percent
					types.NewMoneyMarket("ugert",
						types.NewBorrowLimit(false, sdk.NewDec(100000000*gert_CF), sdk.MustNewDecFromStr("0.8")), // Borrow Limit
						"gert:usd",                   // Market ID
						sdk.NewInt(gert_CF),          // Conversion Factor
						model,                        // Interest Rate Model
						reserveFactor,                // Reserve Factor
			...
			pricefeedGS := pricefeedtypes.GenesisState{
				Params: pricefeedtypes.Params{
					Markets: []pricefeedtypes.Market{
						...
						{MarketID: "gert:usd", BaseAsset: "gert", QuoteAsset: "usd", Oracles: []sdk.AccAddress{}, Active: true},
