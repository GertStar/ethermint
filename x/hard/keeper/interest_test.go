				...
				expectedInterestSnaphots: []ExpectedBorrowInterest{
					{
						elapsedTime:  oneYearInSeconds,
						shouldBorrow: true,
						borrowCoin:   sdk.NewCoin("ugert", sdk.NewInt(1*gert_CF)),
					},
				},
			},
			errArgs{
...
func (suite *KeeperTestSuite) TestSupplyInterest() {
	...
	testCases := []interestTest{
		...
		},
		{
			...
			args{
				user:                 sdk.AccAddress(crypto.AddressHash([]byte("test"))),
				initialBorrowerCoins: sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(100*gert_CF)), sdk.NewCoin("bnb", sdk.NewInt(100*BNB_CF))),
				initialModuleCoins:   sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(1000*gert_CF))),
				depositCoins:         sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(100*gert_CF)), sdk.NewCoin("bnb", sdk.NewInt(100*BNB_CF))),
				coinDenoms:           []string{"ugert"},
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(20*gert_CF)), sdk.NewCoin("bnb", sdk.NewInt(20*BNB_CF))),
				interestRateModel:    normalModel,
				reserveFactor:        sdk.MustNewDecFromStr("0.05"),
				expectedInterestSnaphots: []ExpectedSupplyInterest{
					{
				...
				expectedInterestSnaphots: []ExpectedSupplyInterest{
					{
						elapsedTime:  oneMonthInSeconds,
						shouldSupply: true,
						supplyCoin:   sdk.NewCoin("ugert", sdk.NewInt(20*gert_CF)),
					},
				},
			},
			errArgs{
		...
		},
		{
			...
			args{
				...
				depositCoins:         sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(100*gert_CF))),
				coinDenoms:           []string{"ugert"},
				borrowCoins:          sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(80*gert_CF))),
				interestRateModel:    normalModel,
				reserveFactor:        sdk.MustNewDecFromStr("0.05"),
				expectedInterestSnaphots: []ExpectedSupplyInterest{
					{
