...
import (
	...
	v015hard "github.com/Gert-Chain/core/x/hard/legacy/v0_15"
	v016hard "github.com/Gert-Chain/core/x/hard/types"
)
...
func (s *migrateTestSuite) TestMigrate_GenState() {
	v15genstate := v015hard.GenesisState{
		...
		Deposits: v015hard.Deposits{
			{
				...
				Amount:    sdk.NewCoins(sdk.NewCoin("gert", sdk.NewInt(100))),
		...
		TotalSupplied: sdk.NewCoins(sdk.NewCoin("gert", sdk.NewInt(100))),
