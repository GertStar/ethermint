...
// source: gert/hard/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "gert.hard.v1beta1.GenesisState")
	proto.RegisterType((*GenesisAccumulationTime)(nil), "gert.hard.v1beta1.GenesisAccumulationTime")
}

func init() { proto.RegisterFile("gert/hard/v1beta1/genesis.proto", fileDescriptor_20a1f6c2cf728e74) }
