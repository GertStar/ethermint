...
// source: gert/incentive/v1beta1/params.proto
...
func init() {
	proto.RegisterType((*RewardPeriod)(nil), "gert.incentive.v1beta1.RewardPeriod")
	proto.RegisterType((*MultiRewardPeriod)(nil), "gert.incentive.v1beta1.MultiRewardPeriod")
	proto.RegisterType((*Multiplier)(nil), "gert.incentive.v1beta1.Multiplier")
	proto.RegisterType((*MultipliersPerDenom)(nil), "gert.incentive.v1beta1.MultipliersPerDenom")
	proto.RegisterType((*Params)(nil), "gert.incentive.v1beta1.Params")
}

func init() {
	proto.RegisterFile("gert/incentive/v1beta1/params.proto", fileDescriptor_bb8833f5d745eac9)
}
