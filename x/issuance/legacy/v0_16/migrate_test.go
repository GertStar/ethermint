...
import (
	...
	v015issuance "github.com/Gert-Chain/core/x/issuance/legacy/v0_15"
	v016issuance "github.com/Gert-Chain/core/x/issuance/types"
)
...
func (s *migrateTestSuite) TestMigrate_JSON() {
	...
	data := `{
			...
			"assets": [
				{
					...
					"denom": "hbtc",
					"owner": "gert1dmm9zpdnm6mfhywzt9sstm4p33y0cnsd0m673z",
					"paused": false,
					"rate_limit": {
						"active": false,
						"limit": "0",
		...
		"supplies": [
			{
				"current_supply": { "denom": "ugert", "amount": "100" },
...
func (s *migrateTestSuite) TestMigrate_Supplies() {
	s.v15genstate.Supplies = v015issuance.AssetSupplies{
		{
			CurrentSupply: sdk.NewCoin("ugert", sdk.NewInt(100)),
