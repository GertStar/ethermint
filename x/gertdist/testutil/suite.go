...
// Suite implements a test suite for the gertdist module integration tests
type Suite struct {
	suite.Suite
...
func (suite *Suite) SetupTest() {
	...
	coins := sdk.NewCoins(sdk.NewCoin("ugert", sdk.NewInt(1000000000000)))
	...
	suite.Ctx = ctx
	suite.Addrs = addrs
	suite.Keeper = tApp.GetgertdistKeeper()
