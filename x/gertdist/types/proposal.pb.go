...
// source: gert/gertdist/v1beta1/proposal.proto
...
func init() {
	proto.RegisterType((*CommunityPoolMultiSpendProposal)(nil), "gert.gertdist.v1beta1.CommunityPoolMultiSpendProposal")
	proto.RegisterType((*CommunityPoolMultiSpendProposalJSON)(nil), "gert.gertdist.v1beta1.CommunityPoolMultiSpendProposalJSON")
	proto.RegisterType((*MultiSpendRecipient)(nil), "gert.gertdist.v1beta1.MultiSpendRecipient")
}

func init() {
	proto.RegisterFile("gert/gertdist/v1beta1/proposal.proto", fileDescriptor_22ee2c0b398254fd)
}
