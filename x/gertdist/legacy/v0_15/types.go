...
// Period stores the specified start and end dates, and the inflation, expressed as a decimal representing the yearly APR of gert tokens that will be minted during that period
type Period struct {
...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	cdc.RegisterConcrete(CommunityPoolMultiSpendProposal{}, "gert/CommunityPoolMultiSpendProposal", nil)
}
