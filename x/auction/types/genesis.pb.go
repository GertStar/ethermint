...
// source: gert/auction/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "gert.auction.v1beta1.GenesisState")
	proto.RegisterType((*Params)(nil), "gert.auction.v1beta1.Params")
}

func init() {
	proto.RegisterFile("gert/auction/v1beta1/genesis.proto", fileDescriptor_d0e5cb58293042f7)
}
