...
// source: gert/auction/v1beta1/auction.proto
...
func init() {
	proto.RegisterType((*BaseAuction)(nil), "gert.auction.v1beta1.BaseAuction")
	proto.RegisterType((*SurplusAuction)(nil), "gert.auction.v1beta1.SurplusAuction")
	proto.RegisterType((*DebtAuction)(nil), "gert.auction.v1beta1.DebtAuction")
	proto.RegisterType((*CollateralAuction)(nil), "gert.auction.v1beta1.CollateralAuction")
	proto.RegisterType((*WeightedAddresses)(nil), "gert.auction.v1beta1.WeightedAddresses")
}

func init() {
	proto.RegisterFile("gert/auction/v1beta1/auction.proto", fileDescriptor_b9b5dac2c776ef9e)
}
