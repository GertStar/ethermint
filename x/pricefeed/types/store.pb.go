...
// source: gert/pricefeed/v1beta1/store.proto
...
func init() {
	proto.RegisterType((*Params)(nil), "gert.pricefeed.v1beta1.Params")
	proto.RegisterType((*Market)(nil), "gert.pricefeed.v1beta1.Market")
	proto.RegisterType((*PostedPrice)(nil), "gert.pricefeed.v1beta1.PostedPrice")
	proto.RegisterType((*CurrentPrice)(nil), "gert.pricefeed.v1beta1.CurrentPrice")
}

func init() {
	proto.RegisterFile("gert/pricefeed/v1beta1/store.proto", fileDescriptor_9df40639f5e16f9a)
}
