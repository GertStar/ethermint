...
// source: gert/pricefeed/v1beta1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "gert.pricefeed.v1beta1.GenesisState")
}

func init() {
	proto.RegisterFile("gert/pricefeed/v1beta1/genesis.proto", fileDescriptor_fffec798191784d2)
}
