...
// source: gert/pricefeed/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "gert.pricefeed.v1beta1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "gert.pricefeed.v1beta1.QueryParamsResponse")
	proto.RegisterType((*QueryPriceRequest)(nil), "gert.pricefeed.v1beta1.QueryPriceRequest")
	proto.RegisterType((*QueryPriceResponse)(nil), "gert.pricefeed.v1beta1.QueryPriceResponse")
	proto.RegisterType((*QueryPricesRequest)(nil), "gert.pricefeed.v1beta1.QueryPricesRequest")
	proto.RegisterType((*QueryPricesResponse)(nil), "gert.pricefeed.v1beta1.QueryPricesResponse")
	proto.RegisterType((*QueryRawPricesRequest)(nil), "gert.pricefeed.v1beta1.QueryRawPricesRequest")
	proto.RegisterType((*QueryRawPricesResponse)(nil), "gert.pricefeed.v1beta1.QueryRawPricesResponse")
	proto.RegisterType((*QueryOraclesRequest)(nil), "gert.pricefeed.v1beta1.QueryOraclesRequest")
	proto.RegisterType((*QueryOraclesResponse)(nil), "gert.pricefeed.v1beta1.QueryOraclesResponse")
	proto.RegisterType((*QueryMarketsRequest)(nil), "gert.pricefeed.v1beta1.QueryMarketsRequest")
	proto.RegisterType((*QueryMarketsResponse)(nil), "gert.pricefeed.v1beta1.QueryMarketsResponse")
	proto.RegisterType((*PostedPriceResponse)(nil), "gert.pricefeed.v1beta1.PostedPriceResponse")
	proto.RegisterType((*CurrentPriceResponse)(nil), "gert.pricefeed.v1beta1.CurrentPriceResponse")
	proto.RegisterType((*MarketResponse)(nil), "gert.pricefeed.v1beta1.MarketResponse")
}

func init() {
	proto.RegisterFile("gert/pricefeed/v1beta1/query.proto", fileDescriptor_84567be3085e4c6c)
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.pricefeed.v1beta1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Price(ctx context.Context, in *QueryPriceRequest, opts ...grpc.CallOption) (*QueryPriceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.pricefeed.v1beta1.Query/Price", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Prices(ctx context.Context, in *QueryPricesRequest, opts ...grpc.CallOption) (*QueryPricesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.pricefeed.v1beta1.Query/Prices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) RawPrices(ctx context.Context, in *QueryRawPricesRequest, opts ...grpc.CallOption) (*QueryRawPricesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.pricefeed.v1beta1.Query/RawPrices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Oracles(ctx context.Context, in *QueryOraclesRequest, opts ...grpc.CallOption) (*QueryOraclesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.pricefeed.v1beta1.Query/Oracles", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Markets(ctx context.Context, in *QueryMarketsRequest, opts ...grpc.CallOption) (*QueryMarketsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gert.pricefeed.v1beta1.Query/Markets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.pricefeed.v1beta1.Query/Params",
	}
...
func _Query_Price_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.pricefeed.v1beta1.Query/Price",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Prices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.pricefeed.v1beta1.Query/Prices",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_RawPrices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.pricefeed.v1beta1.Query/RawPrices",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Oracles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.pricefeed.v1beta1.Query/Oracles",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Markets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gert.pricefeed.v1beta1.Query/Markets",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "gert.pricefeed.v1beta1.Query",
	...
	Metadata: "gert/pricefeed/v1beta1/query.proto",
}
